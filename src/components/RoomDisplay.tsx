...
type RoomDisplayProps = { snapshot: ScheduleSnapshot; room: DisplayRoom; stale: boolean; now: number };

export function RoomDisplay({ snapshot, room, stale, now }: RoomDisplayProps) {
